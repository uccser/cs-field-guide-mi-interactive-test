...
$(document).ready(function () {
    ...
    ColourMatcher.help_text = [
        ['Tautokona au kia whakatau moka-24 whero', 'danger'],
        ['Tautokona au kia whakatau moka-24 kākāriki', 'success'],
        ['Kua āwhinatia katoatia', 'secondary'],
    ];
    ColourMatcher.display_hexadecimal = false;

    // Display hexadecimal values
    if (searchParameters.has('hexadecimal')) {
